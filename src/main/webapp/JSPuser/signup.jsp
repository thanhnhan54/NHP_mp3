...
<%--                            <input id="re_password" name="re_password" type="password" placeholder="Re-Password">--%>
<%--                        </p>--%>
<%--                        &lt;%&ndash;                        <input class="submit btn-success btn btn-large" type="submit" value="Login">&ndash;%&gt;--%>
<%--                        <button class="submit btn-success btn btn-large">Sign Up</button>--%>
        ...
        <div class="col-lg-offset-4 col-lg-4" style="margin-top:100px">
            ...
            <div class="block-unit" style="text-align:center; padding:8px 8px 8px 8px;">
                <form class="cmxform" id="signupForm" method="post" action="/signup">
                    ...
                    <fieldset>
                        <h2 class="text-center text-primary" style="font-size: 40px; color: whitesmoke">Signup</h2>
                        <p style="margin-bottom: 40px">
                            ...
                            <input class="form-control-static" id="re_password" name="re_password" type="password" placeholder="Re-Password">
                        </p>
                        ...
                        <div class="row d-flex mr-3" style="margin-bottom: 20px">
                            <div>
                                <ul style="justify-content: center">
                                    <li>
                                        <button style="width: 100%;height: 100%; background: #2a2a2a" class="submit btn-success btn btn-large">signup
                                        </button>
                                    </li>
                                </ul>
                            </div>
